...
class QLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.params = list(mac.agent.q_fc1.parameters()) + list(mac.agent.q_rnn.parameters()) + list(mac.agent.q_fc2.parameters())  # local_q
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            agent_outs_t, local_novelty_loss_t, local_novelty_reward_t = self.mac.forward(batch, t=t, train_mode=True)
